...
# 2511/5936 application bytes previously yielded exactly 59/52 ViP messages,
# with zero PseudoTCP gaps/conflicting retransmissions.  Counts are enough here
# to reject selection of a different flow or an accidental framing scan.
for required in \
    ...
    'P13_D1_OUT_UNFRAMED_BYTES=0' \
    'P13_D1_IN_UNFRAMED_BYTES=0'; do
