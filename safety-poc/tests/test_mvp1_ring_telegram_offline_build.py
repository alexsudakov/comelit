...
class Mvp1RingTelegramOfflineBuildTests(unittest.TestCase):
    ...
    def test_media_and_r30h_code_unchanged_by_hash(self) -> None:
        expected = {
            ...
            "safety-poc/research/media/v1/entrance_p116_r27_repeat_001a_transform.py": "f79ad2afcbeb985e68dfc5f9de090712909190239bdc6dac84d77c170bc97fd6",
            "safety-poc/research/media/v1/ct120_run_p116_r27_repeat_001a_live.sh": "c59bfd7b21590b4fb78be5b2af3167a8a6ec63125e2a78c0c913fd5052f5cc62",
