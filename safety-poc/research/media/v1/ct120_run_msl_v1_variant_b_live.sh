...
print_latency_deltas() {
    ...
    print_delta_marker MSL_B_PHASE_B02_TO_B03A_MS MSL_B_B02_RTPC_MEDIA_OPEN_CONTROL_READY_MONO_MS MSL_B_B03A_001A_QUEUED_MONO_MS "$file"
    print_delta_marker MSL_B_PHASE_B03A_TO_B03B_MS MSL_B_B03A_001A_QUEUED_MONO_MS MSL_B_B03B_001A_TX_COMPLETED_MONO_MS "$file"
    print_delta_marker MSL_B_PHASE_B03B_TO_B04_MS MSL_B_B03B_001A_TX_COMPLETED_MONO_MS MSL_B_B04_DEVICE_ACK_OBSERVED_MONO_MS "$file"
    print_delta_marker MSL_B_PHASE_B04_TO_B05_MS MSL_B_B04_DEVICE_ACK_OBSERVED_MONO_MS MSL_B_B05_FIRST_AUDIO_RTP_MONO_MS "$file"
    print_delta_marker MSL_B_PHASE_B04_TO_B06_MS MSL_B_B04_DEVICE_ACK_OBSERVED_MONO_MS MSL_B_B06_FIRST_VIDEO_RTP_MONO_MS "$file"
...
run_dry_run() {
...

    {
        ...
        msl_b_dry_mark B03A_001A_QUEUED
        msl_b_dry_mark B03B_001A_TX_COMPLETED
        msl_b_dry_mark T13_INITIAL_001A_SENT
        msl_b_dry_mark B04_DEVICE_ACK_OBSERVED
        ...
        echo "MSL_B_POST_001A_FRAME_COUNT=1"
        echo "MSL_B_POST_001A_SAME_REQUEST_ID_COUNT=1"
        echo "MSL_B_POST_001A_BODY32_COUNT=1"
        echo "MSL_B_POST_001A_1800_COUNT=1"
        echo "MSL_B_ACK_REQUEST_ID_MATCH_COUNT=1"
        echo "MSL_B_ACK_HEADER_MATCH_COUNT=1"
        echo "MSL_B_ACK_ADDRESS_ROLE_MATCH_COUNT=1"
        echo "MSL_B_ACK_EXACT_MATCH_COUNT=1"
        echo "MSL_B_DEVICE_0008_COUNT=0"
        echo "MSL_B_DEVICE_000A_COUNT=0"
        echo "MSL_B_DEVICE_RESPONSE_COUNT=1"
        echo "MSL_B_RTPC_OPEN_RESPONSE_COUNT=1"
        echo "ACK_REJECT_WRONG_REQUEST_ID=0"
        echo "ACK_REJECT_WRONG_LENGTH=0"
        echo "ACK_REJECT_WRONG_PREFIX=0"
        echo "ACK_REJECT_WRONG_FLAGS=0"
        echo "ACK_REJECT_ADDRESS_ROLE=0"
        echo "ACK_REJECT_OTHER=0"
    } > "$SESSION_LOG"
    cat "$SESSION_LOG"
