...
Все три gap закрыты в P116/R43B
(`P116_R43B_NATIVE_CALL_ADOPTION_SERIALIZER_EXTRACTION.md`): FIRST_ACK_FLAGS=0x80,
CAPABILITIES opcode 0x0003 / 8 байт, ALERTING opcode 0x000A / 3 байта.
