...
expected_shutdown_branch = text.split('HOLDER_TERMINAL_RESULT=EXPECTED_SHUTDOWN', 1)[0]
if 'HOLDER_TERMINAL_PROOF_GRACEFUL_COMPLETE" = true' not in expected_shutdown_branch:
    raise SystemExit("P105_WRAPPER_TERMINAL_PROOF_STATIC=FAIL")
