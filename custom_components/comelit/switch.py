...
class ComelitEntranceMediaSwitch(SwitchEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_start_failure": status["last_start_failure"],
            "last_start_failure_stage": status["last_start_failure_stage"],
            "last_start_failure_at": status["last_start_failure_at"],
            "transport_last_error": status["transport_last_error"],
            "transport_native_exit_code": status["transport_native_exit_code"],
